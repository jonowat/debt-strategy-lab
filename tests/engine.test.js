...
test('calculateMinPayment: percentage_plus_interest', () => {
...
test('calculateMinPayment: percentage_balance', () => {
...
test('calculateMinPayment: full payoff if below floor', () => {
...
test('Simulation: Single card payoff', () => {
...
test('Simulation: Snowball Strategy', () => {
...
test('Simulation: BT Application', () => {
...
test('Large balance transfer scenario', () => {
